...
async def create_zone(
    ...
    zone = ParkingZone(
        ...
        entrance_latitude=payload.entrance_latitude,
        entrance_longitude=payload.entrance_longitude,
        exit_latitude=payload.exit_latitude,
        exit_longitude=payload.exit_longitude,
...
async def update_zone(
    ...
    if payload.entrance_latitude is not None:
        zone.entrance_latitude = payload.entrance_latitude
    if payload.entrance_longitude is not None:
        zone.entrance_longitude = payload.entrance_longitude
    if payload.exit_latitude is not None:
        zone.exit_latitude = payload.exit_latitude
    if payload.exit_longitude is not None:
        zone.exit_longitude = payload.exit_longitude
